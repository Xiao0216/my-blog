...
export type LifeUniverseContentType = {
  readonly slug: LifeUniverseContentTypeSlug
...
export const LIFE_UNIVERSE_CONTENT_TYPES: ReadonlyArray<LifeUniverseContentType> =
  [
    { slug: "article", label: "文章", description: "成熟的公开写作。" },
    {
      slug: "diary",
      label: "日记",
      description: "按时间记录的个人状态和经历。",
    },
    {
      slug: "project",
      label: "项目",
      description: "工作、产品或个人构建记录。",
    },
    {
      slug: "memory",
      label: "记忆",
      description: "具体经历、偏好、事实或里程碑。",
    },
    { slug: "photo", label: "照片", description: "视觉记忆、旅行或生活影像。" },
    {
      slug: "fragment",
      label: "碎片",
      description: "短笔记、灵感、摘录或未完成观察。",
    },
    {
      slug: "list",
      label: "清单",
      description: "计划、推荐、任务、书单、游戏或目标列表。",
    },
  ]
